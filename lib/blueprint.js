 ...
 */
function copyTpl(type, templatePath, tempValues) {
  var done = this.async();
  var destDirectory = templatePath + this.name;

  this.prompt({
    type    : 'input',
    name    : 'directory',
    message : 'destination directory',
    default : destDirectory
  }, function(answers) {
    destDirectory = answers.directory;
  ...
  this.fs.copyTpl(
    ...
    this.destinationPath(destDirectory + '/' + this.name + '.' + type + '.js'),
    tempValues
  );
}
 ...
 * @param {string} templatePath
 */
function copy(type, templatePath) {
  var done = this.async();
  var destDirectory = templatePath + this.name;
